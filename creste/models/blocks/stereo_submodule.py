...
# Move these to the stereo submodule
# ###############################################################################
...
# def depth_classification(x, num_depth_bins):
#     assert len(x.shape) == 4
#     depth_values = torch.arange(0, num_depth_bins, dtype=x.dtype, device=x.device)
#     depth_values = depth_values.view(1, num_depth_bins, 1, 1)
